...
public class PreOrderTest {
    ...
    public static void main(String[] args) {
        ...
        List<String> resultWithRecursion = new PreOrder<String>().travelWithRecursion(root);
        System.out.println(String.join(", ", resultWithRecursion));
        List<String> resultWithoutRecursion = new PreOrder<String>().travelWithoutRecursion(root);
