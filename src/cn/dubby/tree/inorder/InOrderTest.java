...
public class InOrderTest {
    ...
    public static void main(String[] args) {
        ...
        List<String> resultWithRecursion = new InOrder<String>().travelWithRecursion(root);
        System.out.println(String.join(", ", resultWithRecursion));
        List<String> resultWithoutRecursion = new InOrder<String>().travelWithoutRecursion(root);
